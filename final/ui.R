  ...
  fluidRow(
    column(12,
           helpText("For a detailed description of this project please visit", 
                    a("the link", href="http://rpubs.com/sortega78", target="_blank")),
           helpText("For a code, press", a("here", href = "https://github.com/sortega7878/DATA612/tree/master/final", target="_blank"))
