...
library(reshape2)
movies <- read.csv("https://raw.githubusercontent.com/sortega7878/DATA612/master/final/movies.csv", header = TRUE, stringsAsFactors=FALSE)
ratings <- read.csv("https://raw.githubusercontent.com/sortega7878/DATA612/master/final/ratings.csv", header = TRUE)
